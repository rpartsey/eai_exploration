# Copy of the habitat-sim[v0.2.3]/examples/viewer.py
# https://github.com/facebookresearch/habitat-sim/blob/fffa54376766602c4f12e30d0ee6100d56dd7a96/examples/viewer.py
...
class HabitatSimInteractiveViewer(Application):
    ...
    def __init__(self, sim_settings: Dict[str, Any]) -> None:
        ...
        relative_path_to_font = "../../env/habitat-sim/data/fonts/ProggyClean.ttf"
